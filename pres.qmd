...
[**Penúltima sesión mentoría censo**]{.big-par .center-justified}
...
- Pedir ayuda a TI para que les desarrolle la infraestructura necesaria para esto.

- Nuestro equipo también puede ayudarles.

- Pueden estudiar cómo su equipo podría hacerlo (por ejemplo, en R con `plumber` y `renv`. Con Python preferimos `FastAPI`)
